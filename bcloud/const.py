...
PASSPORT_LOGIN_V3 = PASSPORT_BASE + 'v3/login/api/'
REFERER = PASSPORT_BASE + 'v2/?login'
#USER_AGENT = 'Mozilla/5.0 (X11; Linux x86_64; rv:30.0) Gecko/20100101 Firefox/30.0'
USER_AGENT_NORMAL = 'Mozilla/5.0 (X11; Linux x86_64; rv:31.0) Gecko/20100101 Firefox/31.0 Iceweasel/31.2.0'
USER_AGENT = 'netdisk;6.4.0.6;PC;PC-Windows;6.1.7601;WindowsBaiduYunGuanJia'
...
PCS_URLS_D = 'https://d.pcs.baidu.com/rest/2.0/pcs/'

## 以下常量是模拟的PC客户端的参数.
CHANNEL_URL = 'https://channel.api.duapp.com/rest/2.0/channel/channel?'
PC_USER_AGENT = 'netdisk;6.4.0.6;PC;PC-Windows;6.1.7601;WindowsBaiduYunGuanJia'
